...
function nav(path) {
  ...
  <a class="navbar-brand" href="/">${uiConfig.logo_image ? '<img border="0" oncontextmenu="return false;" draggable="false" alt="'+uiConfig.company_name+'" src="'+uiConfig.logo_link_name+'" height="'+uiConfig.logo_height+'" width="'+uiConfig.logo_width+'">' : uiConfig.logo_link_name}</a>
      ...
      <div class="card text-center">
        ...
        ${UI.disable_video_download ? `` : `
          ...
          <div class="btn-group text-center">
              ...
              <a class="dropdown-item" href="intent:${url}#Intent;type=video/any;package=is.xyz.mpv;S.title=${encoded_name};end;">mpv-android</a>
              <a class="dropdown-item" href="intent:${url}#Intent;type=video/any;package=live.mehiz.mpvkt;S.title=${encoded_name};end;">mpvKt</a>
