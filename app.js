...
function nav(path) {
  ...
  <a class="navbar-brand" href="/">${UI.logo_image ? '<img border="0" oncontextmenu="return false;" draggable="false" style="pointer-events: none;" alt="'+UI.company_name+'" src="'+UI.logo_link_name+'" height="'+UI.logo_height+'" width="'+UI.logo_width+'">' : UI.logo_link_name}</a>
