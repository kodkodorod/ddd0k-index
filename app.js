...
function list(path, id = '', fallback = false) {
    ...
    <div id="update"></div>
    <div id="head_md" style="display:none; padding: 0px 0px;"></div>
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ${navigation}
            ...
            <div class="card text-center">
            <div class="card-body text-center">
              <div class="${UI.file_view_alert_class} monospace-text" id="file_details" role="alert">${name}<br>${size}</div>
            </div>
            <div class="card-body">
...
function file_code(name, encoded_name, size, bytes, url, ext, file_id, cookie_folder_id) {
    ...
    <div class="container"><br>
      ...
      <div class="card text-center">
        <div class="card-body text-center">
          <div class="${UI.file_view_alert_class}" id="file_details" role="alert" style="font-family: monospace; text-align: justify;">${name}<br>${size}</div>
        </div>
        ...
        `<div class="card-body">
          ...
          <div class="card-text text-center">
            <div class="btn-group text-center">
              <a href="${url}" type="button" class="btn btn-dark">Download</a>
    ...
    if (bytes <= 1024 * 1024 * 2) {
        ...
        $("#code_spinner").html("");
        $('#editor').html(`<div class="${UI.file_view_alert_class}" id="file_details" role="alert">Unfortunately, the file size exceeds the allowed limit for preview. The maximum file size that can be previewed is restricted to 2 MB.</div>`);
    }
}
